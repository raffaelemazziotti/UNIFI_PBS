...
Small chemical groups called methyl groups are added to DNA, often at cytosine bases.

High DNA methylation near a gene promoter is usually associated with reduced gene expression.
:::
...
Chemical modifications to histone tails can make chromatin more open or more compact, changing gene accessibility.
:::
...
::: {.info-box}
In simple terms: DNA methylation often acts like a “do not read” signal, while histone modifications can open or close the chromatin structure.
:::
