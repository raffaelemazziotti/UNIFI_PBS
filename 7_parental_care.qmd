...
Attachment is a stable emotional bond between an infant and a caregiver.

It motivates the young animal to stay close to the caregiver, seek protection, and use the caregiver as a secure base for exploration.
:::
...
Attachment is especially important in species with high parental investment.

When offspring depend on care, feeding, protection, and learning, staying close to the caregiver increases survival.
:::
...
::: {.info-box}
Attachment is not simply “love” or “affection”. It is a biological and behavioral <u>system</u> that regulates proximity, safety, stress, and exploration.
:::
...
<u>Blocking</u> this signaling interferes with selective recognition of the lamb.
:::
...
![](images/7_parental_care/figure/7_pc_hpa.jpg){width="70%" .fragment .fade-out data-fragment-index="1"}

![](images/7_parental_care/figure/7_pc_maternal_hpa.png){width="90%"
...
## Epigenetics: regulating genes without changing DNA sequence
...
Epigenetics refers to molecular mechanisms that regulate gene activity without changing the DNA sequence.

These mechanisms help cells decide which genes are accessible, active, or silent.
:::
...
Both influence how easily transcription machinery can access DNA.
:::
...
::: {.info-box}
The genome is the same, but epigenetic marks help determine how strongly different genes are expressed.
:::
...
Small chemical groups called `methyl groups` are added to DNA, often at cytosine bases. In segments of DNA called [CpG islands](https://en.wikipedia.org/wiki/CpG_site){target="_blank"}

High DNA methylation near a gene promoter is usually associated with <u>reduced gene expression</u>.
:::
...
Chemical modifications to [histone](https://en.wikipedia.org/wiki/Histone) tails can make [chromatin](https://en.wikipedia.org/wiki/Chromatin) more open or more compact, changing gene <u>accessibility</u>.
:::
...
- DNA methylation often acts like a “do not read” signal
- Histone modifications can open or close the chromatin structure, regulating the accessibility to specific genes.
:::
...
:::{.centerimg}
![](images/7_parental_care/figure/7_pc_epigen_dna.png){width="100%"
title="DNA methylation can regulate gene expression. In the upper diagram, CpG sites in the regulatory region are largely unmethylated, allowing transcriptional machinery to access the gene and supporting gene expression. In the lower diagram, methyl groups are added to CpG sites within the CpG island. Increased DNA methylation is commonly associated with reduced promoter accessibility and repression of transcription. DNA methylation therefore provides an epigenetic mechanism through which gene expression can be persistently modified without changing the underlying DNA sequence."
}
:::
...
:::{.centerimg}
![](images/7_parental_care/figure/7_pc_epigen_hist.png){width="70%"
title="Histone modifications regulate how accessible DNA is to the transcriptional machinery. DNA is wrapped around histone proteins to form nucleosomes, and the exposed histone tails can be chemically modified by processes such as acetylation, methylation, and phosphorylation. In general, histone acetylation is associated with a more open chromatin configuration that facilitates binding of transcription factors and supports gene expression. Other combinations of histone modifications can recruit regulatory proteins that produce more compact chromatin and repress transcription. These modifications are therefore part of the epigenetic mechanisms that alter gene expression without changing the DNA sequence."
}
:::
...
::: {.card}
Maternal care influences regulation of the hippocampal `glucocorticoid receptor (GR)` gene. Particularly through tactile stimulation (licking/grroming)
...
- increased GR expression ([Nr3c1](https://en.wikipedia.org/wiki/Glucocorticoid_receptor){target="_blank"} is the gene)
:::
...
![](images/7_parental_care/figure/7_pc_hpa_epigen.png){width="100%"
title="Maternal licking and grooming can produce long-lasting epigenetic effects on stress regulation in the offspring. Tactile stimulation activates serotonergic (`5-HT`) signaling in the hippocampus, which engages intracellular pathways involving `cAMP`, `PKA`, and the transcriptional coactivator `CBP`. This promotes binding of the transcription factor `NGFI-A` to regulatory regions of the glucocorticoid receptor gene `Nr3c1`. High maternal licking and grooming is associated with reduced DNA methylation at this promoter, greater NGFI-A binding, and increased hippocampal glucocorticoid receptor (`GR`) expression. Increased GR strengthens negative feedback onto the hypothalamic-pituitary-adrenal (`HPA`) axis, producing lower and more rapidly terminated corticosterone responses to stress. Low maternal care is associated with greater promoter methylation, lower GR expression, and a more prolonged stress response."
}
...
Short separations can <u>increase maternal interaction</u> after reunion and, in some rodent paradigms, are associated with reduced later stress reactivity.
:::
...
:::{.centerimg}
![](images/7_parental_care/figure/7_pc_threeidenticalstrangers.jpg){
  width="75%"
  title="Three Identical Strangers (2018), directed by Tim Wardle."
}
:::
...
The documentary tells the story of three identical triplets who were separated at birth, adopted by different families, and unexpectedly reunited as young adults.
:::

::: {.info-box}
Why is it relevant?

The film provides a striking example of the classic `nature versus nurture` problem.

Because the brothers share the same genome but grew up in different families, their similarities and differences raise questions about how <u>genes, parental care, and early environment interact during development</u>.
:::
...
```{=html}
<div class="quiz-wrap">
  <iframe class="quiz-frame" src="quiz/quiz_pc.html" loading="lazy"></iframe>
</div>
```
