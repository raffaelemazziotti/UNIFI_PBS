...
::: {.card .image-needed}
<u>Image:</u> Roger Sperry and/or schematic of the frog retinotectal system

Suggested file: `images/3_ns_sperry_chemoaffinity.png`
:::
...
::: {.experiment-card}
::: {.exp-header}
Rotation of the eye and regeneration of the optic nerve
:::
...
::: {.card .image-needed}
<u>Image:</u> Sperry eye-rotation experiment

Suggested file: `images/3_ns_sperry_eye_rotation.png`
:::
...
<u>connectivity can be specified by matching molecular information between projecting neurons and their targets</u>.
:::
...
::: {.card .image-needed}
<u>Image:</u> retinal position mapped onto the optic tectum / superior colliculus

Suggested file: `images/3_ns_retinotopic_map.png`
:::
...
`molecular gradient` → `positional information` → `organized biological structure`
:::
...
For some retinal axons, increasing ephrin concentration acts as a <u>repulsive signal</u>.
:::
...
::: {.card .image-needed}
<u>Image:</u> Eph/ephrin gradients in retinal and tectal mapping or stripe assay

Suggested file: `images/3_ns_ephrin_retinotopy.png`
:::
...
::: {.card .image-needed}
<u>Image:</u> axon growing on extracellular matrix / laminin

Suggested file: `images/3_ns_axon_adhesion.png`
:::
...
::: {.card .image-needed}
<u>Image:</u> pioneer axon followed by fasciculating axons

Suggested file: `images/3_ns_fasciculation.png`
:::
...
::: {.card .image-needed}
<u>Image:</u> netrin-mediated attraction of commissural axons toward the midline

Suggested file: `images/3_ns_netrin_midline.png`
:::
...
- previous signals encountered by the axon
- developmental time
:::
...
## Choice points: cross or do not cross

::: {.columns}
::: {.column}

::: {.info-box}
Long-range axons often encounter `choice points` where a small directional decision has major consequences for the final circuit.
:::
...
::: {.card}
Distinct molecular programs alter the receptors expressed by the growth cone and therefore its response to cues at the chiasm.
:::
...
::: {.card .image-needed}
<u>Image:</u> retinal axons choosing to cross or avoid the optic chiasm

Suggested file: `images/3_ns_optic_chiasm_choice.png`
:::
