...
![](images/3_circuit_development/figures/3_cf_invitro.gif){width="100%" title="In vitro cultured neurons"}
![](images/3_circuit_development/figures/3_cf_syn.gif){width="50%" title="Dynamics of synaptic formation"}
...
![](images/3_circuit_development/figures/3_cf_growth_cone.jpg){width="90%"}
...
![](images/3_circuit_development/figures/3_cf_growth_cone2.jpg){width="100%"}
![](images/3_circuit_development/figures/3_cf_growth_cone_fluo.jpg){width="100%"}
...
![](images/3_circuit_development/figures/3_cf_growth_cone_decision.png){width="100%"}
...
![](images/3_circuit_development/figures/3_cf_sperry_map.png){width="50%" title="Retinotopic map in the Tectum."}
![](images/3_circuit_development/figures/3_cf_sperry_v1_map.png){width="60%" title="Maps are everywhere in the brain. This for example is the retinotopic map in V1."}
...
![](images/3_circuit_development/figures/3_cf_sperry_frog.jpg){width="80%" title="Frog optic nerve axons can regenerate and re-establish central connections after injury. In humans, optic nerve axons generally fail to regenerate sufficiently to restore vision."}
...
![](images/3_circuit_development/figures/3_cf_maps_somatosensory.jpg){width="100%" title="Homunculus in the somatosensory cortex."}

![](images/3_circuit_development/figures/3_cf_maps_tonotopy.jpg){width="100%" title="Tonotopic organization in A1"}

:::

![](images/3_circuit_development/figures/3_cf_maps_whiskers.jpg){width="45%" title="Whiskers map in mice."}
...
![](images/3_circuit_development/figures/3_cf_maps_ephrins_retina.jpg){width="80%" title="Localization of EphB Receptors and Ephrin-Bs in Developing Retina."}
...
![](images/3_circuit_development/video/3_cf_growth_cone.mp4){width="100%" autoplay="true"
  muted="true"
  loop="true"}
...
![](images/3_circuit_development/figures/3_cf_growth_cone_pioneer.jpg){width="100%"}
...
![](images/3_circuit_development/figures/3_cf_growth_cone_cross_not_cross.png){width="60%"}
...
![](images/3_circuit_development/figures/3_cf_synaptogenesis.png){width="38%"}
...
![](images/3_circuit_development/figures/3_cf_neuromuscular_junction.png){width="100%"}
...
![](images/3_circuit_development/figures/3_cf_neuromuscular_experiment.png){
  width="100%"
...
![](images/3_circuit_development/figures/3_cf_basal_lamina.png){width="70%"
...
![](images/3_circuit_development/figures/3_cf_agrin_musk.png){width="100%"}
...
![](images/3_circuit_development/figures/3_cf_transient_polyinnervation.png){
  width="100%"
...
::: {.centerimg}
![](images/3_circuit_development/figures/3_cf_syn_cajal.png){width="65%"
...
![](images/3_circuit_development/figures/3_cf_syn_electron_micro.png){width="30%"
...
![](images/3_circuit_development/figures/3_cf_syn_electron_micro2.png){width="30%"
...
::: 
::: {.column}
![](images/3_circuit_development/figures/3_cf_syn_types.png){
  width="100%"
...
![](images/3_circuit_development/figures/3_cf_syn_specificity.png){width="65%"
...
![](images/3_circuit_development/figures/3_cf_syn_cerebellar_basket.png){width="9 5%"
...
![](images/3_circuit_development/figures/3_cf_syn_glia.png){width="9 5%"
...
![](images/3_circuit_development/figures/3_cf_syn_trainsinaptic.png){width="85%"
...
![](images/3_circuit_development/figures/3_cf_syn_pruning.png){width="100%"
}
...
![](images/3_circuit_development/figures/3_cf_myelin.gif){width="100%"
}
...
![](images/3_circuit_development/figures/3_cf_myelin_oligod.png){width="80%"
}
...
![](images/3_circuit_development/figures/3_cf_myelin_ranvier.png){width="80%"
...
![](images/3_circuit_development/figures/3_cf_myelin_ranvier2.png){width="80%"
...
![](images/3_circuit_development/figures/3_cf_myelin_rmi.png){width="100%"
}
...
:::{.centerimg}
![](images/3_circuit_development/figures/3_cf_lorenzosoil.jpg){
  width="75%"
  title="Lorenzo's Oil (1992), directed by George Miller."
}
:::
...
Based on the true story of Lorenzo Odone, a child diagnosed with `X-linked adrenoleukodystrophy (ALD)`, and his parents' search for a treatment.
:::

::: {.info-box}
Why is it relevant?

ALD disrupts the integrity of `white matter` and leads to progressive loss of `myelin`.

The movie illustrates an important principle of neural-circuit development:

<u>Building the correct connections is not enough, axons also require myelination and long-term biological maintenance to function efficiently.</u>
:::
