...
- vision becomes responsive much later and receives relatively little patterned stimulation in utero
:::
...
`Somatosensation` is among the earliest sensory systems to become functional.
...
::: {.card}
4D ultrasound studies suggest that some movements become increasingly anticipatory: mouth movements can begin before the hand reaches the mouth.
:::
...
::: {.info-box}
Maternal tissues and amniotic fluid modify external sounds, especially attenuating higher frequencies, but <u>temporal and prosodic information can still reach the fetus</u>.
:::
...
::: {.card}
Responses become more reliable with maturation.

By the third trimester, the fetus can discriminate some properties of complex sounds, including aspects of speech.
:::
...
<small>[Kisilevsky et al., 1992](https://pubmed.ncbi.nlm.nih.gov/1446565/){target="_blank"}</small>
...
The fetus repeatedly hears the mother's voice during gestation.
:::
:::
...
## Prenatal experience shapes language perception

The fetus does not understand language, but it can learn some of its `acoustic structure`.
...
::: {.card}
Prenatal speech preserves information about:

- rhythm
- intonation
- stress
- broad spectral characteristics
:::
...
::: {.card}
Newborns show sensitivity to properties of the language or languages heard during pregnancy.
:::
...
::: {.info-box}
The first steps of language learning begin with <u>auditory statistical and prosodic learning</u>, before words acquire meaning.
:::

<small>[Moon et al., 2013](https://pubmed.ncbi.nlm.nih.gov/23173548/){target="_blank"} | [Byers-Heinlein et al., 2010](https://pubmed.ncbi.nlm.nih.gov/20424066/){target="_blank"}</small>

## The fetus can learn repeated speech patterns

::: {.experiment-card}

::: {.exp-header}
Learning a repeatedly presented rhyme
:::
...
Mothers repeatedly recited a particular passage during late pregnancy.
:::
:::
...
Later, fetal heart rate was measured while the familiar passage was presented in a different female voice.
:::
:::
...
Fetuses showed a different response to the familiar passage, and memory could persist after exposure had stopped.
:::
:::
...
<small>[Krueger & Garvan, 2014](https://pubmed.ncbi.nlm.nih.gov/24548971/){target="_blank"}</small>
