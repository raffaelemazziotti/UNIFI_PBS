...
![](images/5_neuroplasticity/figures/5_plast_ncom.gif){width="50%"}
...
:::{.centerimg}
![](images/5_neuroplasticity/figures/5_plast_timescale.png){width="50%"}
:::
...
![](images/5_neuroplasticity/figures/5_plast_neural_code_thresh.png){width="50%"
...
![](images/5_neuroplasticity/figures/5_plast_neural_code.jpg){width="100%"
...
![](images/5_neuroplasticity/figures/5_plast_AHN.jpg){width="65%"
...
![](images/5_neuroplasticity/figures/5_plast_hebb.png){
width="50%"}
...
![](images/5_neuroplasticity/figures/5_plast_NMDA.png){
width="80%"}
...
:::{.centerimg}
![](images/5_neuroplasticity/figures/5_plast_LTP.png){
width="65%"
...
![](images/5_neuroplasticity/figures/5_plast_ltp_ampa.png){
width="65%"}
...
:::{.centerimg}
![](images/5_neuroplasticity/figures/5_plast_LTD.png){
width="65%"}
:::
...
![](images/5_neuroplasticity/figures/5_plast_STDP.png){
width="100%"}
...
![](images/5_neuroplasticity/figures/5_plast_structural.png){width="100%"
...
![](images/5_neuroplasticity/figures/5_plast_hebb_dilemma.png){width="100%"
}
...
![](images/5_neuroplasticity/figures/5_plast_homeostatic.png){width="100%"
}
...
![](images/5_neuroplasticity/figures/5_plast_sliding_threshold.png){width="100%"
...
:::{.centerimg}
![](images/5_neuroplasticity/figures/5_plast_homeo_ex_vivo.png){width="100%"
...
## Structural plasticity: spine dynamics in adult visual cortex
...
:::{.info-box}
A small `retinal lesion` creates a scotoma and deprives the corresponding region of adult visual cortex of its normal input.

The same dendritic spines can then be followed over time with [two-photon imaging](https://en.wikipedia.org/wiki/Two-photon_excitation_microscopy){target="_blank"}.

- `Spine density` remains approximately unchanged.
- `Spine survival` strongly decreases.
- The formation of `new persistent spines` increases.
...
![](images/5_neuroplasticity/figures/5_plast_spines_V1.png){
  width="80%"
  title="Structural plasticity during functional reorganization of adult visual cortex. A small retinal lesion creates a region of visual-field loss and deprives the corresponding region of visual cortex of its normal input. Repeated two-photon imaging shows that overall dendritic spine density remains approximately constant, but spine survival decreases strongly and more new persistent spines appear. Thus, apparently stable spine density can conceal extensive synaptic turnover: old spines are eliminated while new ones are formed and stabilized as the cortical circuit reorganizes."
}


:::{.card}
<u>The number of spines is stable, but their turnover dramatically increases.</u>

The circuit is therefore being structurally reorganized without a net change in synapse density.
:::

:::
:::

<small>[Keck et al., 2008](https://www.nature.com/articles/nn.2181){target="_blank"}</small>
...
![](images/5_neuroplasticity/figures/5_plast_frmi_m1.png){width="100%"
...
::: {layout-ncol=2}
![](images/5_neuroplasticity/figures/5_plast_ex_vivo_horizontal.png){width="100%"}

![](images/5_neuroplasticity/figures/5_plast_rat_reaching.gif){width="50%"
...
![](images/5_neuroplasticity/figures/5_plast_reaching_occlusion.png){width="50%"
...
::: {layout-ncol=3}
![](images/5_neuroplasticity/figures/5_plast_thumb.gif){width="60%"
  title="Thumb abduction used in the Motor Practice (MP)"
}

![](images/5_neuroplasticity/figures/5_plast_tms_mep.png){width="50%"
  title="MEP schematics"
}

![](images/5_neuroplasticity/figures/5_plast_m1_pas.png){width="50%"
...
<iframe
  width="60%"
  height="50%"
  src="https://www.youtube.com/embed/qraznXOo0kA"
...
<iframe
  width="60%"
  height="50%"
  src="https://www.youtube.com/embed/FVnIk3Q0twE"
  title="YouTube video player"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowfullscreen>
...
<iframe
  width="60%"
  height="50%"
  src="https://www.youtube.com/embed/jKfCr-OQyFI"
  title="YouTube video player"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowfullscreen>
...
<iframe
  width="60%"
  height="50%"
  src="https://www.youtube.com/embed/XaucQ-2T_qQ"
  title="YouTube video player"
  frameborder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowfullscreen>
...
::: {.card}
Animal models make it possible to <u>measure, manipulate and visualize</u> plasticity at synaptic resolution.
:::
...
:::{.centerimg}
![](images/5_neuroplasticity/figures/5_plast_memento.jpg){
  width="70%"
  title="Memento (2000), directed by Christopher Nolan."
}
:::
...
Leonard describes his condition as a problem of `short-term memory`, but his short-term is largely preserved.
:::
...
A man with severe `anterograde amnesia` is unable to form stable new long-term memories and relies on notes, photographs, and tattoos to reconstruct his recent past.
...
The film raises a central question about memory and plasticity:

<u>How can experience shape behavior if new memories cannot be consolidated?</u>

It highlights the distinction between `short-term experience`, `long-term memory formation`, and the external strategies that can partially compensate when memory systems are impaired.
:::
...
```{=html}
<div class="quiz-wrap">
  <iframe class="quiz-frame" src="quiz/quiz_plast.html" loading="lazy"></iframe>
</div>
```
