...
![](images/1_ns_development/figures/1_ns_dev_intro.gif){width="100%"}
...
![](images/1_ns_development/figures/1_ns_emb_maiale_1.png){ width="80%" fragment-index="0"}

![](images/1_ns_development/figures/1_ns_emb_maiale_2.png){.fragment width="80%" fragment-index="1"}

![](images/1_ns_development/figures/1_ns_emb_maiale_3.png){.fragment width="80%" fragment-index="2"}
...
::: {.r-stack}
![](images/1_ns_development/figures/1_ns_dev_perspective.png){width="100%" fragment-index="0"}

![](images/1_ns_development/figures/1_ns_dev_perspective_2.png){.fragment width="100%" fragment-index="1"}
...
![](images/1_ns_development/figures/1_ns_germ_layers.png){width="100%" fragment-index="1"}
...
![](images/1_ns_development/video/1_ns_neurulation.mp4){width="100%" fragment-index="1"}
...
![](images/1_ns_development/video/1_ns_neurulation.mp4){width="100%"}
![](images/1_ns_development/figures/1_ns_neural_crest.gif){width="100%"}
...
![](images/1_ns_development/figures/1_ns_neurulation_human.png){width="100%"}
...
![](images/1_ns_development/figures/1_ns_neural_tube.png){width="80%"}
...
- the <u>dorsal lip of the blastopore</u> was taken from a donor amphibian gastrula
...
![](images/1_ns_development/figures/1_ns_spemann_experiment.jpg){width="70%"}
...
::: {.r-stack}
![](images/1_ns_development/figures/1_ns_spemann_in_vitro_1.png){ width="80%" fragment-index="0"}

![](images/1_ns_development/figures/1_ns_spemann_in_vitro_2.png){.fragment width="80%" fragment-index="1"}

![](images/1_ns_development/figures/1_ns_spemann_in_vitro.png){.fragment width="80%" fragment-index="2"}
:::
...
![](images/1_ns_development/figures/1_ns_spemann_bmp.png){width="100%"}
...
![](images/1_ns_development/figures/1_ns_axes.png){width="60%"}
...
![](images/1_ns_development/figures/1_ns_morphogens.png){width="100%"}
![](images/1_ns_development/figures/1_ns_regionalization.png){width="70%"}
...
![](images/1_ns_development/figures/1_ns_dorsoventral_gradients.jpg){width="100%"}
...
![](images/1_ns_development/figures/1_ns_regionalization_dorsoventral.png){width="100%"}
...
::: 
::: {.column width="50%"}
![](images/1_ns_development/figures/1_ns_regionalization_dorsoventral_2.png){width="80%"}
::: 
::: 
...
![](images/1_ns_development/figures/1_ns_brain_vescicles.png){width="100%"}
...
![](images/1_ns_development/figures/1_ns_brain_vescicles_anteroposterior.png){width="100%"}
...
![](images/1_ns_development/figures/1_ns_anterodorsal_axis.png){width="88%"}
...
![](images/1_ns_development/figures/1_ns_rhombomers.png){width="88%"}
...
![](images/1_ns_development/figures/1_ns_hox_code.png){width="80%"}
...
![](images/1_ns_development/figures/1_ns_isthmic_organizer.png){width="70%" title="Wnt1 loss-of-function experiment: in Wnt1 mutant mice, much of the developing mesencephalon and rostral metencephalon is lost, showing that Wnt1 signaling at the isthmic organizer is required for normal development of these regions."}
...
![](images/1_ns_development/figures/1_ns_neocortex_gradients.png){width="100%" title="FGF8 manipulation experiment: increasing anterior FGF8 shifts cortical areas posteriorly (C), whereas an ectopic posterior FGF8 source can induce partial duplication of the cortical map, including somatosensory cortex (D)."}
...
![](images/1_ns_development/figures/1_ns_neocortex_regionalization.png){
  width="100%"
...
![](images/1_ns_development/figures/1_ns_protomap_protocortex.png){
  width="100%"
...
:::{.centerimg}
![](images/1_ns_development/figures/1_i_origins.jpg){
  width="75%"
  title="I Origins (2014), written and directed by Mike Cahill."
}
:::
...
A molecular biologist studying the `evolution of the eye` becomes involved in a discovery that challenges his strongly materialistic view of the world.
:::

::: {.info-box}
Why is it relevant?

The movie connects `development and evolution of the visual system` with broader questions about <u>identity, consciousness, and the limits of scientific explanation</u>.

It is also an interesting example of how neuroscience and biology can be used in fiction to explore the tension between `empirical evidence` and `belief`.
:::

[Movie information](https://en.wikipedia.org/wiki/I_Origins){target="_blank"}
