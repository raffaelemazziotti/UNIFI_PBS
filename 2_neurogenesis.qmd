...
![](images/2_neurogenesis/video/2_ndm_neuron_death.mp4){autoplay="true" muted="true" loop="true" controls="False" width="100%"}
...
![](images/2_neurogenesis/figures/2_ndm_radial_glia.png)
...
![](images/2_neurogenesis/figures/2_ndm_divisions_hro_vert.png)
![](images/2_neurogenesis/figures/2_ndm_divisions_ver_or.png)
...
::: {.centerimg}
![](images/2_neurogenesis/figures/2_ndm_neurogenesis_IP.png)
:::
...
![](images/2_neurogenesis/figures/2_ndm_neurogenesis_RGC.jpg){width="70%"}
...
![](images/2_neurogenesis/figures/2_ndm_neurogenesis_CP.png)
...
![](images/2_neurogenesis/figures/2_ndm_neurogenesis_insideout.png){
  width="100%"
...
![](images/2_neurogenesis/figures/2_ndm_neurogenesis_heterochronic.png){width="70%"}
...
![](images/2_neurogenesis/figures/2_ndm_differentiation.png){width="100%"}
...
![](images/2_neurogenesis/figures/2_ndm_diffe_delta_notch.png){width="100%"   title="Notch–Delta lateral inhibition. Neighboring progenitor cells communicate through membrane-bound Delta and Notch. Small initial differences in signaling are amplified over time, producing cells with high Delta and low Notch activity and neighboring cells with high Notch activity. Across a tissue, this generates a heterogeneous salt-and-pepper pattern. At the molecular level, Notch activation releases NICD, which enters the nucleus and induces HES proteins. HES suppresses proneural genes and Delta expression, thereby inhibiting neuronal differentiation in the Notch-high cell while allowing the neighboring Delta-high cell to adopt a neuronal fate."}
...
![](images/2_neurogenesis/figures/2_ndm_diffe_numb.png){width="100%" }
...
![](images/2_neurogenesis/figures/2_ndm_diffe_dlx.png){width="100%" }
...
![](images/2_neurogenesis/figures/2_ndm_diffe_neural_crest.png){width="100%" }
...
![](images/2_neurogenesis/figures/2_ndm_diffe_neural_crest2.png){width="100%" }
...
![](images/2_neurogenesis/figures/2_ndm_pcd.png){width="80%" }
...
:::{.centerimg}
![](images/2_neurogenesis/figures/2_ndm_pcd_apoptosis.png){width="100%" }
:::
...
![](images/2_neurogenesis/figures/2_ndm_pcd_caspase.png){width="100%"
...
![](images/2_neurogenesis/figures/2_ndm_pcd_montalcini.png){width="70%"
...
:::{.centerimg}
![](images/2_neurogenesis/figures/2_ndm_pcd_montalcini_exp.png){width="70%"
...
:::{.centerimg}
![](images/2_neurogenesis/figures/2_ndm_pcd_neurotrophic.png)
:::
...
:::{.centerimg}
![](images/2_neurogenesis/figures/2_ndm_pcd_neurotrophic2.png)
:::
...
:::{.centerimg}
![](images/2_neurogenesis/figures/2_ndm_pcd_trk_receptors.png){
