...
![](images/6_exp_acuity.png){width="90%"
...
:::{.centerimg}
![](images/6_exp_acuity_res.png){width="40%"}
:::
...
![](images/6_exp_spatial_frequncy.png){width="100%"}
...
:::{.centerimg}
![](images/6_exp_contrast.png){width="60%"}
:::
...
![](images/6_exp_disparity.jpg){width="40%"}
...
::: {layout-ncol=2}
![](images/6_exp_monocular_cat.gif){width="100%"}

![](images/6_exp_monocular_cat2.gif){width="100%"}
...
![](images/6_exp_monocuar_clues.png){width="20%"}
...
![](images/6_exp_monocular_shading.jpg){width="20%"}
...
![](images/6_exp_acuity_devel.jpg){width="100%"}
...
![](images/6_exp_photoreceptors.png)
...
![](images/6_exp_retinal_waves.mp4)
...
![](images/6_exp_contrast_dev.jpeg){width="70%"
